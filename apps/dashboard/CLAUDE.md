...
Tools are assembled by **`tools/index.ts`** (`createAllTools`). It composes 12
tool modules exposing ~22 tools total (19 by default; the 3 destructive
