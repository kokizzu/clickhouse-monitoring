...
<Cards>
  ...
  <Card
    title="Traffic"
    href="/guide/features/traffic"
    description="How much data is flowing in — rows, bytes, insert queries, per-table ingestion, and compression over time."
  />
  <Card
    title="Insights"
...
| Traffic | How much data is flowing into the cluster? | `metrics` | [Traffic](/guide/features/traffic) |
